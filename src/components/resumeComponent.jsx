    ...
    return(
        ...
        <div className="a4-wrapper">
            <div className="intro-section">
                ...
                {resumeDetails.title?<h2>FRONT-END WEB DEVELOPER</h2>:null}
                <p>{resumeDetails.about}</p>
            </div>
            <div className="social-section">
                ...
                {resumeDetails.email?<div className="social">
                    ...
                    <p>sourabh.gupta.5095@gmail.com</p>
                </div>:null}
            ...
            {resumeDetails.skills?<div className="skills-sections">
                ...
                <div className="skill-stack">
                    {resumeDetails.skills.split(",").map(skill=><div className="skill"><p>{skill.trim()}</p></div>)}
                </div>
            </div>:null}
